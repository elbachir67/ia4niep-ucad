...
learnerProfileSchema.index({ userId: 1 }, { name: 'learnerProfile_userId_index' });
learnerProfileSchema.index({ 'assessments.category': 1 }, { name: 'learnerProfile_assessments_category_index' });
