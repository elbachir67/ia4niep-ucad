    ...
    <div className="min-h-screen bg-[#0A0A0F] py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400 mt-2">Suivez votre progression et gérez vos parcours d'apprentissage</p>
        </div>
        ...
        {/* Parcours actifs */}
        <div className="mb-12">
          <h2 className="text-xl font-bold text-gray-100 mb-6">Parcours en cours</h2>
          <div className="space-y-4">
              ...
              <div key={pathway._id} className="glass-card p-6 rounded-xl">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    ...
                    <p className="text-gray-400">
                      Module {pathway.currentModule + 1} sur {pathway.moduleProgress.length}
                    </p>
                  </div>
                  <button
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <div className="flex items-center text-gray-400">
                    ...
                    <span>Fin estimée : {formatDate(pathway.estimatedCompletionDate)}</span>
                  </div>
                </div>
              </div>
            ))}
            ...
            {dashboard.activePathways.length === 0 && (
              <div className="text-center py-8">
                <p className="text-gray-400 mb-4">Vous n'avez pas encore de parcours actif</p>
                <button
                  onClick={() => navigate('/goals')}
        ...
        {/* Prochaines étapes */}
        <div className="mb-12">
          <h2 className="text-xl font-bold text-gray-100 mb-6">Prochaines étapes</h2>
            ...
            {dashboard.nextMilestones.map((milestone, index) => (
              <div key={index} className="glass-card p-6 rounded-xl">
                ...
                <div className="flex items-center text-sm text-gray-400">
                  <Calendar className="w-4 h-4 mr-1" />
                  <span>À compléter avant le {formatDate(milestone.dueDate)}</span>
                </div>
              </div>
            ))}
          </div>
        ...
        {dashboard.completedPathways.length > 0 && (
          <div>
            <h2 className="text-xl font-bold text-gray-100 mb-6">Parcours complétés</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {dashboard.completedPathways.map((pathway) => (
                <div key={pathway._id} className="glass-card p-6 rounded-xl">
                  ...
                  <div className="flex items-center justify-between text-sm text-gray-400">
                    <span>Complété le {formatDate(pathway.lastAccessedAt)}</span>
                    <button
                      onClick={() => navigate(`/pathways/${pathway._id}`)}
