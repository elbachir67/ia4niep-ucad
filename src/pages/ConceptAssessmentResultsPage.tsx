...
import { Trophy, Brain, ArrowRight, CheckCircle, XCircle, Lightbulb, RefreshCw } from 'lucide-react';
        ...
        <div className="glass-card rounded-xl p-8 mb-8 text-center">
          ...
          <div className="p-4 rounded-lg bg-gray-800/50 mb-6">
            <p className="text-gray-300 mb-2">
              {result.score >= 80 ? 'Excellent niveau de maîtrise !' :
               result.score >= 60 ? 'Bon niveau de compréhension' :
        ...
        {result.adaptations && (
          <div className="glass-card rounded-xl p-8 mb-8">
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-xl font-bold text-gray-100">Adaptations de votre parcours</h2>
            </div>
            
            <div className="space-y-4">
              {result.adaptations.map((adaptation: any, index: number) => (
                <div key={index} className="p-4 rounded-lg bg-gray-800/50 border-l-4 border-blue-500">
                  <p className="text-gray-200 font-medium mb-2">{adaptation.title}</p>
        ...
        {result.recommendations && (
          <div className="glass-card rounded-xl p-8 mb-8">
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-xl font-bold text-gray-100">Recommandations</h2>
            </div>
            
            <div className="space-y-4">
              {result.recommendations.map((recommendation: any, index: number) => (
                <div key={index} className="flex items-start p-4 rounded-lg bg-gray-800/50">
