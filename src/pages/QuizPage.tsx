...
import { Clock, AlertTriangle, CheckCircle, XCircle, ArrowRight, Loader2, BookOpen, RefreshCcw } from 'lucide-react';
  ...
  const handleQuizComplete = async () => {
    ...
    try {
      ...
      if (score < (quiz.passingScore || 70)) {
        ...
        toast.error(`Score insuffisant. Vous devez obtenir au moins ${quiz.passingScore || 70}% pour valider le quiz.`, {
          duration: 5000
        });
        setSubmitting(false);
        return;
      ...
      <div className="min-h-screen bg-[#0A0A0F] flex items-center justify-center">
        <div className="glass-card rounded-xl p-8 max-w-lg w-full mx-4">
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-bold text-gray-100 mb-2">Score insuffisant</h2>
            <p className="text-gray-400 mb-4">
              Vous devez obtenir au moins {quiz?.passingScore || 70}% pour valider ce quiz et progresser dans votre parcours.
            </p>
            <div className="bg-gray-800/50 p-4 rounded-lg mb-6">
              <p className="text-gray-300 text-lg mb-1">Votre score:</p>
              <p className="text-4xl font-bold text-purple-400">{finalScore}%</p>
              <p className="text-gray-400 mt-2">
                {correctAnswers} réponses correctes sur {questions.length} questions
              </p>
            </div>
          </div>
