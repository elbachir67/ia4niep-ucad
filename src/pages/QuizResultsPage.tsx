...
import { Trophy, Clock, Target, ArrowRight, CheckCircle, XCircle, RefreshCcw } from 'lucide-react';
          ...
          <div className="space-y-4">
            {result.answers.map((answer, index) => (
              <div
                ...
                className={`p-4 rounded-lg ${answer.isCorrect ? 'bg-green-500/10' : 'bg-red-500/10'} flex items-center justify-between`}
              >
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">
                      {answer.isCorrect ? 'Réponse correcte' : 'Réponse incorrecte'} • Temps: {formatTime(answer.timeSpent)}
                    </p>
                  </div>
                </div>
              </div>
