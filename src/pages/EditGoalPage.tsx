    ...
    const fetchGoal = async () => {
      try {
        ...
        setFormData({
          ...
          careerOpportunities: data.careerOpportunities.length > 0 
    ...
    <div className="min-h-screen bg-[#0A0A0F] py-12">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="glass-card p-8 rounded-xl">
          <h1 className="text-3xl font-bold text-gray-100 mb-8">Modifier l'Objectif</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label htmlFor="estimatedDuration" className="block text-sm font-medium text-gray-300">
                ...
                {formData.careerOpportunities.map((opportunity, index) => (
                  <div key={index} className="flex items-center space-x-2">
                    <input
                      type="text"
                      value={opportunity}
                      onChange={(e) => handleCareerOpportunityChange(index, e.target.value)}
