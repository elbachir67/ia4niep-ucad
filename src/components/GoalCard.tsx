...
const GoalCard: React.FC<GoalCardProps> = ({ goal, className = '', isRecommended = false }) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <span className={`px-3 py-1 rounded-full text-sm font-medium ${getDifficultyColor(goal.level)}`}>
          {goal.level}
        </span>
      </div>
